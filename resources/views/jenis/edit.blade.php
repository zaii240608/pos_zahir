        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div class="lg:col-span-5">
                    <div class="bg-white rounded-2xl border border-teal-100 shadow-sm overflow-hidden sticky top-6">
                        ...
                        <div class="px-6 py-5 bg-teal-700 text-white flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-teal-100/80">Perbarui nama kategori ini</p>
                            </div>
                        </div>
                        ...
                        <form action="{{ route('admin.jenis.update', $jenis->id) }}" method="POST" class="p-6 space-y-5">
                            ...
                            <div class="p-3.5 rounded-xl bg-teal-50/50 border border-teal-100/60 grid grid-cols-2 gap-3 text-[11px] text-slate-600">
                                <div>
                                    <span class="block font-semibold text-teal-800/60 uppercase tracking-wider text-[9px]">Dibuat Pada</span>
                                    <span class="font-bold text-slate-700">
                                        {{ $jenis->created_at ? $jenis->created_at->translatedFormat('d M Y, H:i') : '-' }}
                                    </span>
                                </div>
                                <div>
                                    <span class="block font-semibold text-teal-800/60 uppercase tracking-wider text-[9px]">Terakhir Diubah</span>
                                    <span class="font-bold text-slate-700">
                    ...
                    <div class="bg-white rounded-2xl border border-teal-100 shadow-sm overflow-hidden">
                        ...
                        <div class="px-6 py-4 border-b border-slate-100 bg-slate-50/50 flex items-center justify-between">
                            <div class="flex items-center gap-2">
                                <span class="w-1.5 h-4 bg-teal-600 rounded-full inline-block"></span>
                                <h3 class="text-sm font-bold text-slate-800">Daftar Produk Menggunakan Jenis Ini</h3>
                            </div>
                            <span class="px-2.5 py-1 text-xs font-bold text-teal-800 bg-teal-50 border border-teal-100 rounded-lg">
