<nav class="w-full bg-[#0f4c4a] border-b border-teal-800 text-white shadow-md sticky top-0 z-50">
  <div class="w-full px-4 sm:px-6 lg:px-8">
    <div class="flex items-center justify-between h-16 gap-4">
      ...
      <div class="flex items-center space-x-3 shrink-0">
        ...
        <div class="flex items-center space-x-2.5 text-xs bg-teal-950/50 px-3.5 py-1.5 rounded-full border border-teal-800/60">
        ...
        <form action="{{ route('logout') }}" method="POST" class="m-0">
          @csrf
          <button type="submit" class="inline-flex items-center gap-1.5 px-4 py-1.5 border border-rose-500/40 bg-rose-500/20 hover:bg-rose-600 text-rose-100 hover:text-white text-xs font-bold rounded-full transition-all duration-200 hover:shadow-md active:scale-95 focus:outline-none">
            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
